...
BOOL CAboutDlg::OnInitDialog() {
  ...
  m_Credits.SetBackgroundColor(FALSE, OBEDIT_COLOR_GRAY);
  ...
  AddText("Note: ObEdit is a work in progress and likely contains bugs. Not all features are complete or implemented yet. Please use caution and keep backups of all plugins.");
  AddText("");
  AddText("The latest version along with documentation and help can be found at:");
  AddText("     http://www.uesp.net/wiki/Tes4Mod:ObEdit");
  AddText("     http://tes4code.sourceforge.net");
  AddText("");
  AddText("Credits:");
  ...
  AddBullet("Tes4Lib (http://tes4code.sourceforge.net) for loading and manipulating Oblivion data files. ");
  AddBullet("ScripterRon who supplied the source to his TES Plugin Utility (http://www.tessource.net/files/file.php?id=3083) for formid fixups.");
