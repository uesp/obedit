...
BEGIN_MESSAGE_MAP(CObImageCtrl, CWnd)
	//{{AFX_MSG_MAP(CObImageCtrl)
	ON_WM_PAINT()
	ON_WM_VSCROLL()
	ON_WM_HSCROLL()
	//}}AFX_MSG_MAP
...
/*===========================================================================
 *
 * Class CObImageCtrl Constructor
 *
 *=========================================================================*/
CObImageCtrl::CObImageCtrl() {
...
/*===========================================================================
 *		End of Class CObImageCtrl Constructor
 *=========================================================================*/


/*===========================================================================
 *
 * Class CObImageCtrl Destructor
 *
 *=========================================================================*/
CObImageCtrl::~CObImageCtrl() {
...
/*===========================================================================
 *		End of Class CObImageCtrl Destructor
 *=========================================================================*/


/*===========================================================================
 *
 * Class CObImageCtrl Event - void OnInitialUpdate (void);
 *
 *=========================================================================*/
void CObImageCtrl::OnInitialUpdate (void) {
  CRect	ClientRect;
  CDC*  pDC;
...
/*===========================================================================
 *		End of Class Event CObImageCtrl::OnInitialUpdate()
 *=========================================================================*/


/*===========================================================================
 *
 * Class CObImageCtrl Event - void OnPaint ();
 *
 *=========================================================================*/
void CObImageCtrl::OnPaint() {
  CPaintDC DC(this);
  CRect    ClientRect;
  CDC	   BitmapDC;
...
/*===========================================================================
 *		End of Class Event CObImageCtrl::OnPaint()
 *=========================================================================*/


/*===========================================================================
 *
 * Class CObImageCtrl Method - bool Load (pFile, FileSize, Offset);
 *
 * TODO: Does not work?
 *
 *=========================================================================*/
bool CObImageCtrl::Load (FILE* pFile, const long FileSize, const long Offset) {
  HBITMAP   hBMP = NULL;
  BITMAP    BmpInfo;
  CDC*      pDC;
  ILboolean Result;
...
/*===========================================================================
 *		End of Class Method CObImageCtrl::Load()
 *=========================================================================*/


/*===========================================================================
 *
 * Class CObImageCtrl Method - void Load (pFilename);
 *
 *=========================================================================*/
bool CObImageCtrl::Load (const TCHAR* pFilename) {
  HBITMAP   hBMP;
  BITMAP    BmpInfo;
  CBitmap   TempBitmap;
  CDC*      pDC;
...
/*===========================================================================
 *
 * Class CObImageCtrl Event - void OnHScroll (SBCode, nPos, pScrollBar);
 *
 *=========================================================================*/
void CObImageCtrl::OnHScroll (UINT SBCode, UINT nPos, CScrollBar* pScrollBar) {
...
/*===========================================================================
 *		End of Class Event CObImageCtrl::OnHScroll()
 *=========================================================================*/


/*===========================================================================
 *
 * Class CObImageCtrl Event - void OnVScroll (SBCode, nPos, pScrollBar);
 *
 *=========================================================================*/
void CObImageCtrl::OnVScroll (UINT SBCode, UINT nPos, CScrollBar* pScrollBar) {
...
/*===========================================================================
 *		End of Class Event CObImageCtrl::OnVScroll()
 *=========================================================================*/
